...
<body>
    <div class="container">
        ...
        <center>
            <img src="{{ public_path('storage/' . $anggota->foto) }}" alt="Foto Anggota {{ $anggota->nama }}"
        ...
        <div class="table-responsive">
            <table class="table">
                <thead>
                    ...
                    <tr>
                        <th>Alamat</th>
                        <td>{{ $anggota->memberRegistration->alamat }}</td>
                    </tr>
                    <tr>
                        <th>Tempat Lahir</th>
                        <td>{{ $anggota->memberRegistration->tempat_lahir }}</td>
                    </tr>
                    <tr>
                        <th>Tanggal Lahir</th>
                        <td>{{ \Carbon\Carbon::parse($anggota->memberRegistration->tanggal_lahir)->translatedFormat('d F Y') }}
                        </td>
                    </tr>
                    <tr>
                        <th>Agama</th>
                        <td>{{ ucwords($anggota->memberRegistration->agama) }}</td>
                    </tr>
                    <tr>
                        <th>Status</th>
