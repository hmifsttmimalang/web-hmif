    ...
    <div class="container">
        <div class="header-container">
            <div class="img-container">
                <img src="{{ public_path('assets/img/logo_hmif.jpg') }}" alt="Logo HMIF" style="width: 100px; height: auto;">
            </div>
            ...
            <div class="img2-container">
                <img src="{{ public_path('assets/img/cetak/logo_smi_no_bg.png') }}" alt="Logo SMI" style="width: 100px; height: auto;">
            </div>
        </div>
