<template>
    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <!-- User Dropdown -->
            <li class="nav-item dropdown no-arrow" :class="{ show: dropdownOpen }" ref="dropdownRef">
                <a class="nav-link dropdown-toggle" href="#" @click.prevent="toggleDropdown">
                    ...
                    <img class="img-profile rounded-circle" :src="adminImg" alt="Profile">
                </a>
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" :class="{ show: dropdownOpen }">
                    <a class="dropdown-item" href="#" @click.prevent="showLogout = true">
...
const adminName = computed(() => (page.props.currentUser?.nama ?? "Administrator"))
