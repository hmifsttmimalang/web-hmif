        ...
        return {
            ...
            projects: [
                ...
                },
                {
                    ...
                    imgSrc: new URL("@/assets/img/SIPPEKA.png", import.meta.url)
                        .href,
...
<template>
    <section id="portfolio" class="portfolio section">
        <div class="container section-title" data-aos="fade-up">
            <h2>Portfolio</h2>
            <p>
                Proyek ini merupakan inisiatif dari Himpunan Mahasiswa
                Informatika SMI Malang (HMIF SMI MALANG)
            </p>
        </div>
        <div class="container">
