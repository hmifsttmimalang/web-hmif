...
<head>
    ...
    <title>DashHMIF - Admin Control</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a href="#" class="btn btn-warning btn-sm mb-3" data-bs-toggle="modal" data-bs-target="#importModal">
                        Import Data Anggota
                    </a>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal">Hapus</a>
                                            <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#updateAnggotaModal">Update</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td><span class="badge badge-info">Demisioner</span></td>
                                        <td>
                                            <a href="detail_pendaftar.php" class="btn btn-info btn-sm">Cek</a>
                                            <a href="#" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal">Hapus</a>
                                            <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#updateAnggotaModal">Update</a>
        ...
        <div class="modal fade" id="updateAnggotaModal" tabindex="-1" aria-labelledby="updateAnggotaModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">

                    <div class="modal-header">
                        <h5 class="modal-title" id="updateAnggotaModalLabel">Update Anggota</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                    </div>

                    <div class="modal-body">
                        <form id="formUpdateAnggota" method="POST" action="proses_update.php">
                            <!-- Biasanya akan ada hidden ID -->
                            <input type="hidden" name="id_anggota" id="id_anggota">

                            <div class="mb-3">
                                <label for="nama_update" class="form-label">Nama Lengkap</label>
                                <input type="text" class="form-control" name="nama" id="nama_update" required>
                            </div>

                            <div class="mb-3">
                                <label for="prodi_update" class="form-label">Program Studi</label>
                                <select class="form-select" name="prodi" id="prodi_update" required>
                            ...
                            <div class="mb-3">
                                <label for="angkatan_update" class="form-label">Angkatan</label>
                                <input type="text" class="form-control" name="angkatan" id="angkatan_update" required>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" form="formUpdateAnggota">Simpan Perubahan</button>
                    </div>
        ...
        <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="import_anggota.php" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                            <p>Silakan unggah file Excel (.xlsx) yang berisi data anggota.</p>

                            <div class="mb-3">
                                <label for="fileAnggota" class="form-label">Pilih File</label>
                                <input class="form-control" type="file" name="fileAnggota" id="fileAnggota" accept=".xlsx,.csv" required>
                            </div>

                            <div class="alert alert-info small">
                                Format file harus berisi kolom: <strong>Nama, Prodi, Angkatan, Email, No. HP, Jabatan dan Foto Pas 3x4</strong>.
                            </div>
                        </div>
        ...
        <div class="modal fade" id="confirmDeleteModal" tabindex="-1" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Apakah kamu yakin ingin <strong>menghapus data ini?</strong> Tindakan ini tidak bisa dibatalkan.</p>
                    </div>

                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                        <form action="hapus_data.php" method="POST">
                            <!-- Gunakan input hidden jika perlu kirim ID -->
