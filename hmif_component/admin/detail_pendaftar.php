            ...
            <div id="content">
                ...
                <div class="col-md-6">
                            <div class="card shadow mb-4">
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <h6 class="mb-1" style="color: black; font-weight: bold; text-align: left;">Angkatan</h6>
                                        <h6 class="mb-0" style="color: black; text-align: left;">2023</h6>
                                    </li>
                                    <li class="list-group-item">
                                        <h6 class="mb-1" style="color: black; font-weight: bold; text-align: left;">Alasan Bergabung</h6>
                                        <h6 class="mb-0" style="color: black; text-align: left;">Karena ingin join</h6>
                                    </li>
                                </ul>
