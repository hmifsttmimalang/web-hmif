                  ...
                  <form @submit.prevent="submit" novalidate>
                    ...
                    <div class="form-group row">
                      <div class="col-md-6">
                        ...
                        <div class="invalid-feedback d-block" v-if="form.errors.tempat_lahir">{{ form.errors.tempat_lahir }}</div>
                      </div>
                      <div class="col-md-6">
                        <label for="tanggal_lahir">Tanggal Lahir</label>
                        <input type="date" v-model="form.tanggal_lahir" class="form-control" id="tanggal_lahir" required />
                        <div class="invalid-feedback d-block" v-if="form.errors.tanggal_lahir">{{ form.errors.tanggal_lahir }}</div>
                      </div>
                    </div>
                    <!-- Jenis Kelamin & Agama -->
                    <div class="form-group row">
                      <div class="col-md-6">
                        ...
                        <div class="invalid-feedback d-block" v-if="form.errors.jenis_kelamin">{{ form.errors.jenis_kelamin }}</div>
                      </div>
                      <div class="col-md-6">
                        ...
                        <div class="invalid-feedback d-block" v-if="form.errors.agama">{{ form.errors.agama }}</div>
                      </div>
                    </div>
                    <!-- Alamat -->
                    <div class="form-group">
                      ...
                      <div class="invalid-feedback d-block" v-if="form.errors.alamat">{{ form.errors.alamat }}</div>
                    </div>
                    <!-- NIM -->
                    <div class="form-group">
                      <label for="nim">NIM</label>
                      <input type="number" v-model="form.nim" class="form-control" id="nim" required placeholder="Masukkan NIM Lengkap Anda..." />
                      <div class="invalid-feedback d-block" v-if="form.errors.nim">{{ form.errors.nim }}</div>
                    </div>
                    <!-- Prodi -->
                    <div class="form-group">
                      ...
                      <div class="invalid-feedback d-block" v-if="form.errors.prodi">{{ form.errors.prodi }}</div>
                    </div>
                    <!-- Foto -->
                    <div class="form-group row">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="text" v-model="form.angkatan" class="form-control" id="angkatan" required />
                        <div class="invalid-feedback d-block" v-if="form.errors.angkatan">{{ form.errors.angkatan }}</div>
                      </div>
                    </div>
                    <!-- Alasan -->
                    <div class="form-group">
                      ...
                      <div class="invalid-feedback d-block" v-if="form.errors.alasan">{{ form.errors.alasan }}</div>
                    </div>
                    <!-- Email & Telepon -->
                    <div class="form-group row">
                      <div class="col-md-6">
                        <label for="email">Email</label>
                        <input type="email" v-model="form.email" class="form-control" id="email" required placeholder="Email Aktif Anda..." autocomplete="email" />
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="invalid-feedback d-block" v-if="form.errors.telepon">{{ form.errors.telepon }}</div>
                      </div>
                    </div>
                    <!-- Password -->
                    <div class="form-group row">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="invalid-feedback d-block" v-if="form.errors.terms">{{ form.errors.terms }}</div>
                    </div>
                    <!-- Modal -->
                    ...
                    <br>
                    <button type="submit" class="btn btn-primary btn-user btn-block" :disabled="form.processing">Registrasi</button>
                  </form>
                  <hr>
                  <div class="text-center">
                    <Link class="small" :href="route('login')">Sudah punya akun? Login!</Link>
                  </div>
                  <!-- Notif error/sukses -->
                  <div v-if="form.hasErrors" class="alert alert-danger mt-3">
                    <div v-for="(msg, field) in form.errors" :key="field">{{ msg }}</div>
                  </div>
                  <div v-if="form.recentlySuccessful" class="alert alert-success mt-3">
                    Registrasi berhasil!
                  </div>
                </div>
              </div>
