                  ...
                  <form @submit.prevent="submitForm" ref="formRef" novalidate>
                    ...
                    <div class="form-group row">
                      <div class="col-md-6">
                        ...
                        <div class="form-check">
                          <input type="radio" v-model="form.jenis_kelamin" value="P" class="form-check-input"
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" v-model="form.nim" class="form-control" id="nim" required
                    ...
                    <div class="form-group row">
                      <div class="col-md-6">
                        ...
                        <input id="foto" style="padding:3px" type="file" @change="onFileChange" class="form-control"
                          required />
                      </div>
                      <div class="col-md-6">
                        <label for="angkatan">Angkatan</label>
                        <input style="padding:3px" type="text" v-model="form.angkatan" class="form-control"
                          id="angkatan" placeholder="Tahun Bergabung..." required />
                      </div>
                    </div>
                    <!-- Alasan -->
                    <div class="form-group">
                    ...
                    <div class="form-group row">
                      <div class="col-md-6">
                        ...
                        <input type="email" v-model="form.email" class="form-control" id="email" required
                          placeholder="Email Aktif Anda..." autocomplete="additional-name" />
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="password" v-model="form.konfirmasi_password" class="form-control" id="konfirmasi_password"
                      ...
                      <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <p>Dengan mencentang kotak persetujuan, Anda telah membaca dan menerima semua syarat dan
                              ketentuan di atas.</p>
                          </div>
...
async function submitForm() {
  ...
  try {
    ...
    const res = await axios.post("/api/pendaftaran", formData, {
      headers: {
